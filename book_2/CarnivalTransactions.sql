...
VALUES
('Ed', 'Edston', 'ed@ed.com', '111-222-1212', 8),
('Rick', 'Edston', 'rick@ed.com', '111-222-4543', 8),
('Bobbi', 'Edston', 'bobbi@ed.com', '111-222-2345', 8),
('Bipimbap', 'Edston', 'bib@ed.com', '111-222-1234', 8),
('Sharkeisha', 'Edston', 'shark@ed.com', '111-222-6543', 8);
...
where d.business_name LIKE ('Sollowaye%') OR d.business_name LIKE ('Hrishchenko%') OR d.business_name LIKE ('Cadreman%');
...
INSERT INTO
dealerships(business_name, city, state, tax_id, phone, website)
VALUES
('Felphun Automotive', 'Washington', 'D.C.', '23-u70-5t-5689', '123-111-4321', 'www.felphunauto.com');
...
public.employees(first_name,last_name,email_address,phone,employee_type_id)
VALUES
('Joe', 'Mayne', 'joe@ed.com', '111-222-6767', 3),
('Jim', 'Bruh', 'jim@ed.com', '111-222-9990', 4),
('Yancy', 'Yeet', 'yancy@ed.com', '111-222-0098', 6);
