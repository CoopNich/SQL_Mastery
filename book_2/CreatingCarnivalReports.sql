...
CREATE OR REPLACE FUNCTION sale_returned_record() RETURNS TRIGGER LANGUAGE PLPGSQL AS $$ BEGIN
INSERT INTO accountsreceivable (
        debit_amount,
        date_received,
        sales_id
...
AFTER
UPDATE ON sales FOR EACH ROW EXECUTE PROCEDURE sale_returned_record ();
SELECT *
FROM SALES;
