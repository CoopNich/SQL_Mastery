...
FROM dealerships d
	...
	ON d.dealership_id = e.employee_id
...
FROM vehicles v
	...
	INNER JOIN vehiclebodytype body
	ON vt.vehicle_body_type_id = body.vehicle_body_type_id
	INNER JOIN vehiclemake make
	ON vt.vehicle_make_id = make.vehicle_make_id
	INNER JOIN vehiclemodel model
	ON vt.vehicle_model_id = model.vehicle_model_id;